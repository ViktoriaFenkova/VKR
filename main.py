...
with col2:
    ...
    st.write("Создавайте, редактируйте и актуализируйте Правила внутреннего контроля вашей организации с учётом требований законодательства и стандартов ПОД/ФТ")


a = '''


Здесь вы можете создавать и редактировать внутренние правила по ПОД/ФТ


# Примечания по оформлению
    st.markdown("<br><center>Copyright © 2023 Все права защищены.</center>", unsafe_allow_html=True)

Генерация презентации для проведения обучения")
